...
namespace Infrastructure.Migrations.Basket
{
    ...
    [Migration("20200930132418_basketItemNew_Migration")]
    partial class basketItemNew_Migration
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Entities.CustomerBasket", b =>
                {
                    ...
                    b.Property<int?>("ItemBasketItemId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("ItemBasketItemId");
            ...
            modelBuilder.Entity("Core.Entities.CustomerBasket", b =>
                {
                    b.HasOne("Core.Entities.BasketItem", "Item")
                        .WithMany()
                        .HasForeignKey("ItemBasketItemId");
                });
