...
namespace Infrastructure.Migrations.Basket
{
    ...
    [Migration("20200930120625_Id_BasketItem_Migration")]
    partial class Id_BasketItem_Migration
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Entities.CustomerBasket", b =>
                {
                    ...
                    b.Property<int?>("ItemsBasketItemId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("ItemsBasketItemId");
            ...
            modelBuilder.Entity("Core.Entities.CustomerBasket", b =>
                {
                    b.HasOne("Core.Entities.BasketItem", "Items")
                        .WithMany()
                        .HasForeignKey("ItemsBasketItemId");
                });
