...
namespace Infrastructure.Migrations.Basket
{
    ...
    [Migration("20200930132056_basketItem_Migration")]
    partial class basketItem_Migration
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Entities.CustomerBasket", b =>
                {
                    ...
                    b.Property<int?>("BasketItemsBasketItemId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("BasketItemsBasketItemId");
            ...
            modelBuilder.Entity("Core.Entities.CustomerBasket", b =>
                {
                    b.HasOne("Core.Entities.BasketItem", "BasketItems")
                        .WithMany()
                        .HasForeignKey("BasketItemsBasketItemId");
                });
